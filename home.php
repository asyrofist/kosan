  ...
  <div class="container">
    ...
    <ul class="timeline">
      ...
      <li class="timeline-inverted">
        <div class="timeline-image"><img class="rounded-circle" src="https://lh3.googleusercontent.com/p/AF1QipO4pRR_YaDnxH1wi4pnNqkxhXGyou6A26815B4W=w296-h202-n-k-no-v2" alt="" /></div>
        <div class="timeline-panel">
          <div class="timeline-heading">
            <h4>March 2011</h4>
      ...
      <li>
        <div class="timeline-image"><img class="rounded-circle" src="https://lh3.googleusercontent.com/p/AF1QipNW-Dvl7uWemKa6Ni9rDRA4VXOQL9Ceayjc8XGY=w296-h202-n-k-no-v1" alt="" /></div>
        <div class="timeline-panel">
          <div class="timeline-heading">
            <h4>December 2012</h4>
